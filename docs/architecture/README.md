...
İlk command use-case'inin katmanları, portları ve trade-off'ları [CQRS ve Create Wallet Application Akışı](02-cqrs-ve-application-katmani.md) belgesindedir.
